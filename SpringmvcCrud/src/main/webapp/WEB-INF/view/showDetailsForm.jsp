...
<body>
    <h1>Show Product Details</h1>
        <%--@elvariable id="productModel" type="com"--%>
        <form:form action="UpdateProduct"  modelAttribute="productModel" method="post">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <form:input type="text" cssClass="form-control" path="expirationDate" readonly="true"/>
                        ...
                        <div class="form-group">
                            ...
                            <form:input type="text" cssClass="form-control" path="available"  readonly="true"/>
